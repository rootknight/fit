...
var Fit = class {
  ...
  getClashedChanges(localChanges, remoteChanges) {
    ...
    const clashedFiles = localChangePaths.map((path, localIndex) => {
...
var FitSettingTab = class extends import_obsidian4.PluginSettingTab {
  constructor(app, plugin) {
    ...
    this.repoInfoBlock = async () => {
      ...
      this.repoSetting = new import_obsidian4.Setting(containerEl).setName("Github repository name").setDesc("Select a repo to sync your vault, refresh to see your latest repos. If some repos are missing, make sure your token are granted access to them.").addDropdown((dropdown) => {
